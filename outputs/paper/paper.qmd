...
All data was collected and cleaned using the statistical programming language `R` [@R]. The packages used are `tidyverse` [@tidyverse], `dplyr` [@dplyr], `stringr` [@stringr], and `janitor` [@janitor]. Besides, `here` [@here], `modelsummary` [@modelsummary], `girdExtra` [@gridExtra], `usmap` [@usmap], `knitr` [@knitr], `kableExtra` [@kableExtra] are used to analyze the data.
